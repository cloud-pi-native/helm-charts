...
![Version: 1.0.2](https://img.shields.io/badge/Version-1.0.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 9.18.0](https://img.shields.io/badge/AppVersion-9.18.0-informational?style=flat-square)
...
| opencds.healthcheckPath | string | `"/api/v1/health"` | Console CPN opencds container healthcheck endpoint. |
