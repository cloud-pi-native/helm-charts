...
| common | object | `{"dso/environment":"env","dso/organization":"org","dso/project":"project","oneagent.dynatrace.com/inject":"true"}` | Informations communes, notamment appliquées en label sur les différents objets |
