...
![Version: 2.2.16](https://img.shields.io/badge/Version-2.2.16-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 9.6.0](https://img.shields.io/badge/AppVersion-9.6.0-informational?style=flat-square)
...
| server.proxy.env | object | `{"http_proxy":"http://proxy.example.com:3128","https_proxy":"http://proxy.example.com:3128","no_proxy":".cluster.local,.svc.cluster.local,.svc"}` | Map of environment variables to inject into the plugins initContainers. |
